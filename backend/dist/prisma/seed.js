...
async function main() {
    ...
    const coach1 = await prisma.user.upsert({
        ...
        create: {
            ...
            firstName: 'Carlos',
            lastName: 'Martínez',
            role: client_1.UserRole.ENTRENADOR,
    ...
    const player1 = await prisma.user.upsert({
        ...
        create: {
            ...
            firstName: 'Juan',
            lastName: 'Pérez',
            role: client_1.UserRole.JUGADOR,
            age: 24,
            position: client_1.PlayerPosition.MEDIOCAMPO,
            jerseyNumber: 10,
            phone: '+502 11111111',
        },
    });
    const player2 = await prisma.user.upsert({
        ...
        create: {
            ...
            role: client_1.UserRole.JUGADOR,
            age: 22,
            position: client_1.PlayerPosition.DEFENSA,
            jerseyNumber: 4,
            phone: '+502 22222222',
        },
    });
    const player3 = await prisma.user.upsert({
        ...
        create: {
            ...
            role: client_1.UserRole.JUGADOR,
            age: 25,
            position: client_1.PlayerPosition.DELANTERO,
            jerseyNumber: 9,
            phone: '+502 33333333',
        },
    });
